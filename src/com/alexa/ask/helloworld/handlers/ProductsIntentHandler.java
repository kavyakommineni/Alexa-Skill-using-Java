 ...
 *
 */
public class ProductsIntentHandler implements RequestHandler {
	static UserRestServices rest = new UserRestServices();
	
    @Override
    public boolean canHandle(HandlerInput input) {
        return input.matches(intentName("ProductsIntent"));
    }
    ...
    public Optional<Response> handle(HandlerInput input) {
    	...
    	speechText = "To know your products, can you please confirm your order id?";
